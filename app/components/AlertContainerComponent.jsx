...
const AlertContainer = () => {
  ...
  return (
    <div
      className={`absolute h-[100svh] w-screen z-20 top-0 left-0 ${
...
const Alert = ({ type, message }) => {
  ...
  return (
    <Box className="absolute w-96 flex flex-col items-center shadow-xl rounded-xl bg-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
      <Box
